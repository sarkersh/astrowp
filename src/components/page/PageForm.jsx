...
export default function PostForm({ postId,postTitle, publishDate, status, content, action }) {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if ( !data.errors && response.ok) {
                ...
                const _successMessage = (action === 'Update') ? 'Page updated successfully' : 'Page created successfully'
